...
import cssAdapter from '@/styles/components/dynamic_background/DynamicBackground';
...
export default function DynamicBackground({ weatherVariable, gestureHandling }: DynamicBackgroundProps) {
    const styles = cssAdapter(weatherVariable);

    return (
        <View style={styles.PAGE_CONTAINER} {...gestureHandling}>
