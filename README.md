...
<div align="center">
  <img src="./Aurora/assets/images/svgs/Sun.svg" width="100"/>
...
<div align="center">
  <img src="./Aurora/assets/screen-recordings/aurora-demo.gif" alt="Aurora Weather App Demo" width="300">
</div>

## Overview

**Aurora** is a modern, cross-platform mobile weather application built with React Native and Expo. Designed with a focus on minimalit UI/UX practices, Aurora provides users with comprehensive weather information, including current conditions, hourly forecasts, and detailed metrics such as UV index, moon phases, and more.
...
│   ├── bookmark.tsx             # Adding new locations to bookmarks
│   ├── forcast.tsx              # Weekly weather forecast
│   ├── index.tsx                # Home screen with current weather
│   ├── location.tsx             # Switch between different locations
│   └── weather.tsx              # Today's hourly weather forecast and atmospheric metrics
│
...
│   │   ├── Snowflakes.tsx
│   │   ├── Wind.tsx
│   │   └── ... (moon phases, illustrations and other icons)
│   │
